...
void keyboard(unsigned char key, int x, int y)
{
    ...
    case 'k':
        ...
        glutTimerFunc(100, moveHuman, 0);
        glutPostRedisplay();
        PlaySound("F:/CodeBlocks/My Computer Graphics Program Files/universalTestBed/SHAHIDMINAR.wav", NULL, SND_FILENAME|SND_ASYNC);
...
{
    cout << endl << "------Shaheed Minar------" << endl << endl;

    cout << "Press F To Move The Birds" << endl << endl;
    cout << "Press G To Stop The Movement of Birds" << endl << endl;
    cout << "Press C To Move The Clouds" << endl << endl;
    cout << "Press V To Stop The Movement of Clouds" << endl << endl;;
    cout << "Press R For Rain Effects" << endl << endl;
    cout << "Press T To Stop Rain Effects" << endl << endl;
    cout << "Press N To Activate Night Mode" << endl << endl;
    cout << "Press D To Switch Back To Day Mode" << endl << endl;
    cout << "Press K For Activating 21st February Mode" << endl << endl;
    cout << "Press T To Switch Back To Day Mode" << endl << endl;
